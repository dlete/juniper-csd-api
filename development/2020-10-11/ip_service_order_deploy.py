...
def csd_service_order_deploy(csd_host: str,
    ...
    from build_csd_api_request_site_order_validate import build_csd_api_requests_site_order_validate
    body_content = build_csd_api_requests_site_order_validate(input_values)
...
def example_of_use():
    ...
    input_values = {
        ...
        'service_order_id': '32604321',                             # does YES have effect
