...
def build_csd_api_requests_site_order_deploy_or_validate(input_values: dict) -> str:
...
def example_of_use():
    ...
    # issue the query
    response = build_csd_api_requests_site_order_deploy_or_validate(so_input_values)
    pprint(response)
