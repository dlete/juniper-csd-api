...
def example_of_use():
    ...
    so_input_values = {
        'service_order_action': 'SaveAndDeployNow',
        'service_order_name': 'so_site_del_dist2_039_126_202012031702',  # DOES mind, MUST be unique
        'service_order_comment': 'service_order_comment',
        ...
        'service_endpoint_id': '32702876',  # "ServiceEndpointID" in Get an IP Service By Service ID
        'reference_customer_id': '30900306',
        'reference_service_definition_id': '24215577',
        'reference_service_id': '32473128',
    }
