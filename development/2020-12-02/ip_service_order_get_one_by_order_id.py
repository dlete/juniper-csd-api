...
def get_an_ip_service_order_by_order_id(csd_host: str,
                                        username: str,
                                        password: str,
                                        order_id: str,
    ...
    page 1728, API Connectivity Services Director API Reference, version 5.2R1
    Chapter:IP Service Orders Management RESTful Web Services
    Section: Get an IP Service Order By Order ID (Version 2)
...
def example_of_use():
    ...
    try:
        # issue the query
        response = get_an_ip_service_order_by_order_id(host,
                                                       username,
                                                       password,
                                                       order_id,
                                                       debug_level)
