...
def build_l3vpn_site_del_payload(input_values):
    ...
    Args:
        input_values (dict): collection of administrative and technical
                             values for a Service Order in CSD
...
def example_of_use():
    ...
    input_values = {
        ...
        'service_order_name': 'so_site_del_dist2_039_116_202012021657',
