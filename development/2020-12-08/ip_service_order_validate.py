...
def csd_service_order_validate(csd_host: str,
                               username: str,
                               password: str,
                               input_values: dict,
                               debug_level: str = 'WARNING') -> dict:
    """Validate a CSD Service Order
    ...
    from build_csd_api_request_service_order_validate import build_csd_api_requests_service_order_validate
...
def example_of_use():
    ...
    input_values = {
        'service_order_name': 'so_1005_1652',                   # does NOT care, does NOT have effect
        'service_order_id': '32604389',                         # DOES care
        'service_order_action': 'ValidateNow',                  # DOES care
        'service_order_schedule': '2019-12-11T13:57:28.000Z',   # does NOT care, does NOT have effect
    }
    ...
    # issue the query
    response = csd_service_order_validate(host, username, password, input_values, debug_level)
    # response = l3vpn_site_add(host, username, password, service_id)
    pprint(response)
