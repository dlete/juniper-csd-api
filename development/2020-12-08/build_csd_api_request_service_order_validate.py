...
def build_csd_api_requests_service_order_validate(input_values: dict) -> str:
    ...
    Args:
        input_values (dict):    collection of administrative and technical values
                                for a Service Order in CSD
    ...
    template = env.get_template('csd_service_order_validate.xml.j2')
...
def example_of_use():
    ...
    # issue the query
    response = build_csd_api_requests_service_order_validate(so_input_values)
    pprint(response)
