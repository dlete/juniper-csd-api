...
def example_of_use():
    ...
    so_input_values = {
        'service_order_action': 'SaveAndDeployNow',
        'service_order_name': 'so_site_del_edge4_043_126_202012091445',  # DOES mind, MUST be unique
        'service_order_comment': 'service_order_comment',
        ...
        'service_endpoint_id': '32702897',  # "ServiceEndpointID" in Get an IP Service By Service ID
