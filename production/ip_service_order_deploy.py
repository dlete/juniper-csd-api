...
def csd_service_order_deploy(csd_host: str,
                             username: str,
                             password: str,
                             input_values: dict,
                             debug_level: str = 'WARNING') -> dict:
    """Deploy a CSD Service Order
    ...
    input_values = {
        ...
        'service_order_id': '32604392',
        'service_order_action': 'DeployNow',
    ...
    from build_csd_api_request_service_order_validate \
        import build_csd_api_requests_service_order_validate
    body_content = build_csd_api_requests_service_order_validate(input_values)
    ...
    #
    # Issue request to API endpoint
    #
    # compose and launch the request
    try:
    ...
    #
    # Compose the return and end
    #
    # prepare the data to return as output as a dictionary
    request_output = {
...
def example_of_use():
    ...
    input_values = {
        ...
        'service_order_id': '32604409',                             # does YES have effect
        'service_order_action': 'DeployNow',                        # does YES have effect
    ...
    # issue the query
    response = csd_service_order_deploy(host, username, password, input_values, debug_level)
    # response = csd_service_order_deploy(host, username, password, input_values)
    pprint(response)
