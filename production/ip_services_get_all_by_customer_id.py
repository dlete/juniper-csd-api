...
def get_all_ip_services_by_customer_id(csd_host: str,
                                       username: str,
                                       password: str,
                                       customer_id: str,
    ...
    page 1819, API Connectivity Services Director API Reference, version 5.2R1
    Chapter: IP Services Management RESTful Web Services
    Section: Get All IP Services By Customer ID or Name
...
def example_of_use():
    ...
    try:
        # issue the query
        response = get_all_ip_services_by_customer_id(host,
                                                      username,
                                                      password,
                                                      customerId,
                                                      debug_level)
        # response = get_all_ip_services_by_customer_id(host, username, password, customerId)
