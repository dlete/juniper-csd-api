...
def l3vpn_site_add(csd_host: str,
    ...
    input_values = {
        ...
        'service_order_name': 'so_site_add_dist2_039_1114_09291509',
        ...
        'site_a_uni_description': '(ZZ) if 114 description',
        'site_a_uni_unit_id': '114',
        'site_a_uni_vlan_id': '114',
        'site_a_uni_ipv4_address': '10.10.14.1',
        'site_a_uni_ipv4_mask': '30',
        'site_a_route_distinguisher': '1213:4',
        'site_a_uni_ipv6_address_and_mask': 'fd00:10:10:14::1/126',
    ...
    * SaveAndDeployLater (Create, Save, and Deploy Later a SO)
    ...
    # if input_values['site_a_uni_inet_policer_out_name']:
    if input_values.get('site_a_uni_inet_policer_out_name') is not None:
        # print('you YES want policer')
        ...
        # print('do NOT want policer')
        # Compose the body, the payload, for the API request
        from build_api_request_add_pol_no import build_l3vpn_site_add_payload
        body_content = build_l3vpn_site_add_payload(input_values)
...
def example_of_use():
    ...
    route_distinguisher = settings.SCHOOLS_ROUTE_DISTINGUISHER

    customer_id = settings.SCHOOLS_CUSTOMER_ID
    servicedefinition_id = settings.SCHOOLS_SERVICE_DEFINITION_ID
    service_id = settings.SCHOOLS_SERVICE_ID
    ...
    so_input_values = {
        'service_order_action': 'SaveAndDeployNow',
        'service_order_name': 'so_site_add_edge4_043_125_202012091511',
        'service_order_comment': 'service_order_comment, daniel through api',
        'service_order_user': username,
        'site_a_pe_hostname': 'edge4-testlab',
        'site_a_pe_id': '31424516',
        'site_a_pe_interface': 'ge-0/0/43',
        ...
        'site_a_uni_ipv4_mask': '30',
        'site_a_route_distinguisher': route_distinguisher,
        'site_a_uni_ipv6_address_and_mask': 'fd00:10:10:125::1/126',
        'reference_customer_id': customer_id,
        'reference_service_definition_id': servicedefinition_id,
